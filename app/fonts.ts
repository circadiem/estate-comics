 ...
 * Lives at app/fonts.ts (source of truth: design/fonts.ts). Applied on <html> in app/layout.tsx:
 *
...
export const nunito = Nunito_Sans({
  ...
  display: 'swap',
  // Next 14.2 has no fallback-metric table for Nunito Sans and warns on every
  // build ("Failed to find font override values"). The metric-adjusted
  // fallback is a CLS nicety only; the token stack's system-ui fallback stands.
